...
const members = [
  { avatar: "/avatar/avatar1.jpg", name: "Họ và Tên 1", studentId: "CE000001" },
  { avatar: "/avatar/avatar2.jpg", name: "Họ và Tên 2", studentId: "CE000002" },
  { avatar: "/avatar/avatar3.jpg", name: "Họ và Tên 3", studentId: "CE000003" },
  { avatar: "/avatar/avatar4.jpg", name: "Họ và Tên 4", studentId: "CE000004" },
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6">
          {members.map((member, i) => (
            ...
            >
              {/* Avatar */}
              <div className="relative w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden border-2 transition-all duration-300 group-hover:scale-105 group-hover:shadow-[0_0_24px_rgba(6,182,212,0.5)]"
              ...
              >
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  style={{ background: "linear-gradient(to bottom, transparent, rgba(6,182,212,0.2))" }}
                />
              </div>
