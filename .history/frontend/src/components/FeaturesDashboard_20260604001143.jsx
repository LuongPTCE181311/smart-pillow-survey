  ...
  return (
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-4xl font-bold text-center">Dashboard Test</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-10">
          ...
          <div className="p-6 bg-card rounded-3xl border border-primary">
            ...
            <h3 className="text-primary mt-4 font-semibold">Sleep Score</h3>
            <p className="text-accent-cyan text-3xl mt-2">92%</p>
          </div>

          <div className="p-6 bg-card rounded-3xl border border-primary">
            <Wifi className="text-green-400" />
            <h3 className="text-primary mt-4 font-semibold">Monitoring</h3>
            <p className="text-accent-cyan text-3xl mt-2">Online</p>
          </div>
        </div>
      </div>
    </section>
