    ...
    <section className="py-32 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-center text-primary mt-5 max-w-3xl mx-auto">
            ...
            return (
              <motion.div
                ...
                className="
                    ...
                    "
              >
                <div className="w-16 h-16 rounded-2xl bg-accent-cyan-light flex items-center justify-center">
                  <Icon size={30} className="text-accent-cyan" />
                </div>
                <h3 className="mt-6 text-2xl font-semibold text-primary">
                  {item.title}
                </h3>
                <p className="mt-4 text-secondary">{item.desc}</p>
              </motion.div>
            );
          })}
        </div>
